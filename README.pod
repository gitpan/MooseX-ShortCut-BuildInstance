...
This module is a shortcut to build L<Moose> instances on the fly.=head1 SYNOPSIS
...
=head1 Build/Install from Source - (for example git)
...
Then (adjusting make as needed (dmake?))
